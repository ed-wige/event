...
<body ng-app="mainModule" ng-controller="mainController" style="background-color:white;">
  ...
  S'enregistrer
                    ...
                    <div class="input-field col s6 m6 l6">
                      <p class="margin medium-small" style="color:white;">Vous etes deja inscrit?</p>
                    </div>
                    <div class="input-field col s6 m6 l6">
                        <p class="margin right-align medium-small"><a href="../controlleurs/verifierAdmin.php" style="color:red;">Se connecter</a></p>
                    </div>          
